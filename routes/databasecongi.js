...
async function initializeCollections(db) {
  ...
  // Migrate existing data to add end_date if missing
  // await db.collection('subscriptionstable').updateMany(
  //   { end_date: { $exists: false } },
  //   { $set: { end_date: { $dateAdd: { startField: "$start_date", unit: "day", amount: 30 } } } }
  // );
